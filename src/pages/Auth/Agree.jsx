...
const Agree = () => {
  ...
  const [agreements, setAgreements] = useState({
    term1: false, // 기본 이용약관
    term2: false, // 개인정보 수집 및 이용 동의
    term3: false, // 개인정보처리방침
  });
  ...
  const renderAgreeItem = ({ keyName, label, path }) => (
    <div className="agree-item">
      <div className="checkbox-content">
        <button
          type="button"
          className="checkbox"
          onClick={() => toggleAgreement(keyName)}
        >
          <svg
            width="18"
            height="18"
          ...
          >
            <path
              ...
              fill={agreements[keyName] ? "var(--subBlue)" : "var(--gray3)"}
            />
          </svg>
        </button>
      ...
      <button type="button" className="detail" onClick={() => navigate(path)}>
    ...
    <div className="agree page">
      ...
      <div className="agree-list">
        ...
        <div className="agree-all">
          <button type="button" className="checkbox" onClick={toggleAll}>
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
