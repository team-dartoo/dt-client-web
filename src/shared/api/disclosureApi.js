...
const FIXTURE_DISCLOSURES = [
  {
    ...
    payload: {
      ...
      corpCls: "Y",
      flrName: "한온시스템",
      receptionDate: "2026-05-29T12:30:00Z",
...
export const mockDisclosureListResponse = {
  ...
  disclosures: [
    // ===== 한온시스템 =====
    {
      ...
      flrName: "한온시스템",
      receptionDate: "2026-05-29T01:30:00Z",
      ...
      schemaVersion: "1.0",
      createdAt: "2026-05-29T00:30:00Z",
      updatedAt: "2026-05-29T00:30:00Z",
    },
    {
      _id: "20250925000485",
      reportName: "[기재정정]한온시스템주요사항보고서(유상증자결정)",
      company: {
        corpCode: "00161125",
        corpName: "한온시스템",
        stockCode: "018880",
...
const extraSearchCompanies = [
  ...
  },
  {
    ...
    corpCls: "Y",
    disclosureCount: 820,
    latestDisclosureDate: "2025-09-25T00:00:00Z",
    tags: ["반도체", "사업보고서"],
  },
  {
    corpCode: "00126238",
    ...
    corpCls: "Y",
    disclosureCount: 364,
    latestDisclosureDate: "2025-09-22T00:00:00Z",
    tags: ["전자부품", "분기보고서"],
  },
  {
    corpCode: "00126380",
    ...
    corpCls: "Y",
    disclosureCount: 287,
    latestDisclosureDate: "2025-09-21T00:00:00Z",
    tags: ["보험", "실적"],
  },
  {
    corpCode: "00104856",
  ...
  },
  {
    ...
    corpCls: "Y",
    disclosureCount: 243,
    latestDisclosureDate: "2025-09-16T00:00:00Z",
    tags: ["IT서비스", "클라우드"],
  },
  {
    corpCode: "00126371",
    ...
    corpCls: "Y",
    disclosureCount: 189,
    latestDisclosureDate: "2025-09-15T00:00:00Z",
    tags: ["바이오", "의약품"],
  },
  {
    corpCode: "00126399",
    ...
    corpCls: "Y",
    disclosureCount: 231,
    latestDisclosureDate: "2025-09-14T00:00:00Z",
    tags: ["플랜트", "건설"],
  },
  {
    corpCode: "00149655",
